...
| 3️⃣ | **实时数据增量监听** | 监听收银数据库/接口，实时同步新订单/退单/改价/结账/库存变动 | AI 永远和收银数据一致 | ⚠️ 基础实现 |
| 4️⃣ | **小票打印逆向解析** | 监听收银机网口/串口打印机，解析小票内容生成结构化订单 | 适配所有无API、无数据库权限的杂牌收银机 | ⚠️ 基础实现 |
...
| 2️⃣ | **主动式智能推荐** | 结合历史销量、库存、顾客口味、当前活动，主动推荐菜品/套餐/凑单 | 提高客单价10%-15% | ⚠️ 基础实现 |
| 3️⃣ | **全场景自动答疑** | 覆盖营业时间/包间/停车/打包/辣度/忌口/优惠等200+常见问题 | 不用员工回微信、接电话答疑 | ✅ 已实现 |
| 4️⃣ | **多模态交互支持** | 支持文字、语音、图片识别（拍菜单点菜） | 老人、小孩都能轻松用 | ⚠️ 基础实现 |
